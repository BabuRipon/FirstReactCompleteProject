...
class Contact extends Component{
   ...
   validate(firstname,lastname,telnum,email){
     ...
     if(this.state.touched.firstname&&firstname.length<3)
          error.firstname="First name length should be >=3 charecter";
     else if(this.state.touched.firstname&&firstname.length>10)
          error.firstname="First name length should not be >=10 charecter";
                   ...
                   <div className="col-12 col-md-9">
                       <Form onSubmit={this.handleSubmit}>
                        ...
                        <FormGroup row>
                           ...
                           <Col md={10}>
                             <Input type="textarea" name="message" id="message" value={this.state.message} rows="12" onChange={this.handleInputChange}/>
                           </Col>
                        </FormGroup>
